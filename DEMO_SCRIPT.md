...
- job-agent as the primary proof point
- PKM as knowledge-system evidence
...
- Claude is used for reasoning and strategy.
- Codex is used for repo execution and structured updates.
...
- practical automation around real projects
- product judgment
