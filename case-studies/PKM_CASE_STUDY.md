...
This case study records the PKM knowledge-feed and source-capture concept. The examples use synthetic/demo data; the project supports the main Job-agent story rather than replacing it as the lead proof point.
