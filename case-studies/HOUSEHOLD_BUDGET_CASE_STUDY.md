...
This case study records the household-budget concept and its recruiter-safe evidence boundary. The examples use synthetic/demo data; the public site currently prioritises the Job-agent proof rather than presenting this supporting project as a live product.
