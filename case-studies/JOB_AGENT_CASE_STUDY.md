...
The [static job-agent UX snapshot](https://marcus.uden.dev/proof/job-agent/demo/) gives recruiters and internal reviewers a no-install click-through of the main workflow surfaces as they appear in the current frontend.
