...
The repository also has a [published static demo portal](https://theonedarkhorse.github.io/ai-native-proof-of-work-demo/) for no-install review of historical job-agent, PKM, and household budget snapshots. It is published from a separate demo repository so the portfolio repository can keep local indexes and sensitive source material outside the public surface.
