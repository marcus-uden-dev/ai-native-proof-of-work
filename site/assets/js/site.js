...
if (promptGenerator) {
  ...
  function userFacingApiError(payload, status) {
    const messages = {
      ...
      provider_credits_exhausted: 'The best things in life are free — sadly, API credits are not. The AI review credits have run out, so we are switching to a backup provider. Please be patient and try again soon.',
