...
Status: Privacy-safe screenshots and visual evidence
...
The displayed company names, salaries, sources, household data, and financial values are synthetic examples.
Do not replace these with real private data unless the screenshots have passed a separate privacy review.
